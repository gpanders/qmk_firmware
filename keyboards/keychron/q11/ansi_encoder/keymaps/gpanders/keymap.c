...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        MC_3,     CTL_T(KC_ESC),  KC_A,     KC_S,     KC_D,        KC_F,        KC_G,           KC_H,    KC_J,         KC_K,       KC_L,        KC_SCLN,  KC_QUOT,                KC_ENT,             KC_HOME,
    ...
    [SYMBOLS] = LAYOUT_91_ansi(
        _______,  _______,        KC_BRID,  KC_BRIU,  KC_MCTL,     KC_LPAD,     RGB_VAD,        RGB_VAI,  KC_MPRV,     KC_MPLY,    KC_MNXT,     KC_MUTE,  KC_VOLD,      KC_VOLU,  KC_INS,   KC_DEL,   KC_MUTE,
        _______,  _______,        _______,  _______,  _______,     _______,     _______,        _______,  _______,     _______,    _______,     _______,  _______,      _______,  _______,            _______,
        _______,  _______,        S(KC_1),  S(KC_2),  S(KC_LBRC),  S(KC_RBRC),  RGB_SPI,        _______,  S(KC_7),     S(KC_8),    S(KC_MINS),  _______,  _______,      _______,  _______,            _______,
        _______,  _______,        S(KC_6),  S(KC_4),  S(KC_9),     S(KC_0),     KC_GRV,         _______,  KC_EQL,      S(KC_EQL),  KC_MINS,     _______,  _______,                _______,            _______,
        _______,  _______,                  _______,  KC_LBRC,     KC_RBRC,     S(KC_GRV),      _______,  S(KC_BSLS),  S(KC_COMM), S(KC_DOT),   _______,  _______,                _______,  _______,
